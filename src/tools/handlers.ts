import { NewsItem, NicheDigest } from '../types.js';
import { z } from 'zod';
...
export async function handleGetLatestNews(args: z.infer<typeof GetLatestNewsSchema>) {
...
export async function handleSearchAiNews(args: z.infer<typeof SearchAiNewsSchema>) {
...
export async function handleGetNicheDigest(args: z.infer<typeof GetNicheDigestSchema>) {
